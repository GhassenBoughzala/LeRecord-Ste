      ...
      pages.push(
        <li key={i} active={i === currentPage} onClick={() => onPageChange(i)}>
          <a
            href="#"
            aria-current="page"
            class="bg-blue-50 border border-gray-300 text-blue-600 hover:bg-blue-100 hover:text-blue-700  py-2 px-3 dark:border-gray-700 dark:bg-gray-700 dark:text-white no-underline"
          >
            {i}
          </a>
        </li>
