        ...
        <div className="box-border flex flex-col items-center content-center px-8 mx-auto leading-6 text-black border-0 border-gray-300 border-solid md:flex-row max-w-7xl lg:px-16">
          ...
          <div className="box-border order-first w-full text-black border-solid md:w-1/2 md:pl-10 md:order-none">
            ...
            <p className="pt-4 pb-8 m-0 leading-7 text-gray-700 border-0 border-gray-300 sm:pr-12 xl:pr-32 lg:text-lg">
              ...
              lancements, les étigueteuses, fer à repasser, une diversité des
              ciseaux, l’huile blanche, détacher... Notre but est de vous servir
              et de vous satisfaire.{" "}
            </p>
            <Button
              isButton={false}
              title="Catalogue"
              icon={ "fas fa-arrow-right mx-2" }
              moreStyle="text-black lg:text-xl md:text-2xl justify-center shadow-lg border border-gray-100 hover:text-blue-900"
              href="/catalogue"
            />
          </div>
        </div>
