...
<section className="py-12 sm:py-16 bg-white">
    <div className="max-w-7xl px-10 mx-auto sm:text-center">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10 my-12 sm:my-16">
            ...
            <div className="rounded-lg py-6 flex flex-col items-center justify-center shadow-lg border border-gray-100">
                <p className="font-bold mt-4">Les ciseaux</p>
            </div>
            <div className="rounded-lg py-6 flex flex-col items-center justify-center shadow-lg border border-gray-100">
                <p className="font-bold mt-4">Une diversité de coupe</p>
            </div>
            <div className="rounded-lg py-6 flex flex-col items-center justify-center shadow-lg border border-gray-100">
            ...
            <div className="rounded-lg py-6 flex flex-col items-center justify-center shadow-lg border border-gray-100">
                <p className="font-bold mt-4">Accesoires de coupe</p>
            </div>
            <div className="rounded-lg py-6 flex flex-col items-center justify-center shadow-lg border border-gray-100">
                <p className="font-bold mt-4">Stylos de marquages, crayons, et crates</p>
            </div>
            <div className="rounded-lg py-6 flex flex-col items-center justify-center shadow-lg border border-gray-100">
                <p className="font-bold mt-4">Agrafes et Agrafeuses</p>
            </div>
            <div className="rounded-lg py-6 flex flex-col items-center justify-center shadow-lg border border-gray-100">
                <p className="font-bold mt-4">Etiqueteuse et etiquette de lancement</p>
            </div>
            ...
            <div className="rounded-lg py-6 flex flex-col items-center justify-center shadow-lg border border-gray-100">
                <p className="font-bold mt-4">Fer à repasser et les semelles</p>
            </div>
            <div className="rounded-lg py-6 flex flex-col items-center justify-center shadow-lg border border-gray-100">
                <p className="font-bold mt-4">Accesoires de repassage</p>
            </div>
