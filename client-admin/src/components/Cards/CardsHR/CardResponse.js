...
import TableDropdownResponse from "components/Dropdowns/HRDropDowns/TableDropdownResponse";

export default function CardResponse({ color }) {
  return (
    <>
      <div
        className={
